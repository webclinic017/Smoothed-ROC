...
def stats(s_n, range_str, a, b, date_range, trading_pair):
    data_source = Path(f'Z:/results/{s_n}/{range_str}/sl{a}-{b}/{date_range}/sqn/{trading_pair}_1m.npy')
...
stats('smoothed-roc-stops', '1-1000,1-500,1-1000', '50', '50', '2020-01-01_2020-01-30', 'BNBUSDT')
